...
To sign commits with ED25519-SK or ECDSA-SK:

1. **Generate a key on your hardware security key:**
   ```bash
...
- Make sure your GPG keys are properly configured in the GitHub Actions environment
